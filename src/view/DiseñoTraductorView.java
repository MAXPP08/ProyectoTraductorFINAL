...
public class DiseñoTraductorView extends javax.swing.JFrame {
    ...
    private void ButtonAñadirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ButtonAñadirActionPerformed
        palabra.setEspaniol(JOptionPane.showInputDialog("Escriba la Palabra en "
                + "Español"));
        palabra.setIngles(JOptionPane.showInputDialog("Escriba la Palabra en "
                + "Ingles"));
        ...
        if (model.ESaIN(palabraESaIN, palabra.getEspaniol()) == null) {
            ...
            JOptionPane.showMessageDialog(null,"La palabra que está tratando "
    ...
    //  Area de texto de resultados de las traducciones
    ...
    private void ButtonEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ButtonEliminarActionPerformed
        ...
        String Eliminar_Palabra = JOptionPane.showInputDialog("Ingrese una "
                + "palabra para Eliminar");
